...
sidebarTitle: "Why not Postgres"
description: "Why a correct ledger is not a schema problem."
icon: "database"
keywords: ["Postgres", "triggers", "correctness", "double-entry"]
---
